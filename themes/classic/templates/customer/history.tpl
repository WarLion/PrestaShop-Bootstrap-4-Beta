...
{block name='page_content'}
  ...
  {if $orders}
    <table class="table table-striped table-bordered table-labeled d-xs-none d-md-inline-flex">
      <thead class="thead-default">
        <tr>
          <th>{l s='Order reference' d='Shop.Theme.Checkout'}</th>
          <th>{l s='Date' d='Shop.Theme.Checkout'}</th>
          <th>{l s='Total price' d='Shop.Theme.Checkout'}</th>
          <th class="d-md-down">{l s='Payment' d='Shop.Theme.Checkout'}</th>
          <th class="d-md-down">{l s='Status' d='Shop.Theme.Checkout'}</th>
      ...
      <tbody>
        {foreach from=$orders item=order}
          <tr>
            ...
            <td class="d-md-down">{$order.details.payment}</td>
            <td>
              <span
            ...
            <td class="text-sm-center d-md-down">
